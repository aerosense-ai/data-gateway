...
class InvalidNodeIdError(GatewayError, ValueError):
    """Raise if an invalid node_id (such as 0, which is reserved for the base station) is specified in the configuration"""
